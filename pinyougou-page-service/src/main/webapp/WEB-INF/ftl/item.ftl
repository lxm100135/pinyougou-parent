...
购热销商品</em>
					...
					<div class="clearfix choose">
						...
						<#list specificationList as specification>
							...
							<#list specification.attributeValue as option> 
								<dd><a href="javascript:;" 
								class="{{isChose('${specification.attributeName}','${option}')?'selected':''}}" 
								ng-click="selectSpecification('${specification.attributeName}','${option}')">${option}
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									<#list customAttributeItemsList as custom>
									<#if custom.value??>
